...
( function( api ) {
	...
	// Extends our custom "newsmunch" section.
	api.sectionConstructor['newsmunch'] = api.Section.extend( {
...
jQuery(document).ready(function($) {
	 jQuery("#sub-accordion-section-newsmunch_sidebar_options select:not(#_customize-input-newsmunch_default_pg_sidebar_option),#sub-accordion-section-newsmunch_typography_options select, #sub-accordion-section-newsmunch_headings_typography select").prop('disabled', true);
});